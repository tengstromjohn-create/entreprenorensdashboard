  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-6">
      <div className="flex items-center gap-2 mb-4">
        <Activity size={18} className="text-[#0E3047]" />
        <h3 className="font-semibold text-[#0E3047]">Corporate Health Check</h3>
      ...
      <div className="flex items-center gap-6">
        <div className="relative w-24 h-24 flex-shrink-0">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-2xl font-bold text-[#0E3047]">{result.overall_score}</span>
          </div>
        </div>
      ...
      <div className="flex gap-3 mt-4">
        <button
          ...
          className="flex-1 bg-[#F5F5F0] text-[#0E3047] py-2 rounded-lg text-sm font-medium hover:bg-[#E8E4DE] transition-colors flex items-center justify-center gap-1"
        >
          Visa detaljer
          <ArrowRight size={14} />
        </button>
        <button
          onClick={onRunAgain}
          className="flex-1 bg-[#0E3047] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#1A4060] transition-colors"
        >
          Kör igen
        </button>
      </div>
