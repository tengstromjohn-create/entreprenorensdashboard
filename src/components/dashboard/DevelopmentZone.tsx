...
export function DevelopmentZone() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-[#1F2A30]">Min utveckling</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-100 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-semibold text-[#1F2A30]">Kunskapsbibliotek</h3>
      ...
      <div className="bg-white rounded-lg border border-gray-100 p-6">
        <div className="flex items-center gap-2 mb-4">
          <Video size={18} className="text-[#1F2A30]" />
          <h3 className="font-semibold text-[#1F2A30]">Nästa live-session</h3>
        </div>
        <div className="bg-[#F5F5F0] rounded-lg p-4 flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-[#1F2A30]">{NEXT_SESSION.title}</p>
      ...
      <div className="bg-white rounded-lg border border-gray-100 p-6">
        <div className="flex items-center gap-2 mb-4">
          <Users size={18} className="text-[#1F2A30]" />
          <h3 className="font-semibold text-[#1F2A30]">Entreprenörs-communityt</h3>
        </div>
      ...
      <div className="bg-gradient-to-br from-[#1F2A30] to-[#2F3A40] rounded-xl p-8 text-white text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button className="bg-white text-[#1F2A30] px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-2">
      ...
      <div className="bg-[#F5F5F0] rounded-lg p-6 text-center">
        <p className="text-sm font-semibold text-[#1F2A30] mb-1">Inre Kretsen</p>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-sm text-[#1F2A30] font-medium hover:underline"
        >
